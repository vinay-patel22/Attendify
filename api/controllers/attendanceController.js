...
exports.getAttendanceReport = async (req, res) => {
  /*
    ...
    1. $match: Filters attendance records to the specific month and year.

    2. $group: Groups the records by employeeId and calculates counts of different attendance statuses (present, absent, halfday, holiday).

    3. $lookup: Joins employee details from the employees collection based on employeeId.

    4. $unwind: Flattens the array of employee details.
    
    5. $project: Projects the necessary fields (attendance counts and employee details) for the final output.
